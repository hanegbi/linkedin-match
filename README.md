...
3. Select the first option, "Download larger data archive, including connections, verifications, contacts, account history, and information we infer about you". The other option's checklist does not include connections, so this is the one you need.
4. Click "Request archive". LinkedIn will confirm your password and start preparing the file. This can take anywhere from a few minutes to about a day.
5. Wait for the email from LinkedIn, then come back to the same page and download the file.
